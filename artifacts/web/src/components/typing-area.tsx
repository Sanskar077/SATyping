...
export function TypingArea({
  ...
  const {
    ...
    appendChars, handleBackspace, deleteTrailing, composeChars, language,
  } = engine;
  ...
  }, [language, isCompleted, appendChars, handleBackspace, deleteTrailing, composeChars, textareaRef]);
